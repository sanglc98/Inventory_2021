                ...
                <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                            ...
                            <input type="password" name="old_password" class="form-control{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="Mật khẩu cũ" value="" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" placeholder="Mật khẩu mới" value="" required>
                        </div>
                    </div>
                    <div class="card-footer">
                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="{{ asset('assets/img/Sang.jpg') }}" alt="">
