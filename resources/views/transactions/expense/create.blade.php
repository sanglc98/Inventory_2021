                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('transactions.type', ['type' => 'expense']) }}" class="btn btn-sm btn-primary">Quay lại</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('transactions.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">Thông tin chi phí</h6>
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-title">Tên</label>
                                ...
                                <div class="form-group{{ $errors->has('amount') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-amount">Số tiền</label>
                                ...
                                <div class="form-group{{ $errors->has('reference') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-reference">Ghi chú</label>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">Hoàn thành</button>
                                </div>
                            </div>
                        </form>
                    </div>
