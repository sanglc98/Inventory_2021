                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'income']) }}" class="btn btn-sm btn-primary">Thêm thu nhập</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <td class="td-actions text-right">
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route('transactions.destroy', $transaction) }}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Xóa" onclick="confirm('Bạn có chắc muốn xóa thu nhập này? Dữ liệu sẽ bị xóa vĩnh viễn.') ? this.parentElement.submit() : ''">
