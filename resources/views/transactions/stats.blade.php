        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                        <table class="table">
                            <thead>
                                <th data-toggle="tooltip" data-placement="bottom" title="Thống kê theo chu kỳ">Thời gian</th>
                                <th>Giao dịch</th>
                                <th>Thu nhập</th>
                                <th>Chi phí</th>
                                <th>Thanh toán</th>
            ...
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('clients.index') }}" class="btn btn-sm btn-primary">Xem Khách hàng</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Thống kê theo Methods</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('methods.index') }}" class="btn btn-sm btn-primary">Xem Methods</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-full-width table-responsive">
                        <table class="table">
                            <thead>
                                <th>Method</th>
                                <th>Giao dịch trong {{ $date->year }}</th>
                                <th>Số dư {{ $date->year }}</th>
                                <th></th>
                            </thead>
                            <tbody>
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-8">
                        <h4 class="card-title">Thống kê bán hàng</h4>
                    </div>
                    <div class="col-4 text-right">
                        <a href="{{ route('sales.index') }}" class="btn btn-sm btn-primary">Xem mục Bán</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        ...
                        <th>Khách hàng</th>
                        <th>Tổng số lượng</th>
                        <th data-toggle="tooltip" data-placement="bottom" title="Doanh thu trung bình cho mỗi lần bán hàng">Trung bình cộng</th>
                        <th>SỐ TIỀN THANH TOÁN</th>
                        <th>Cần hoàn thiện</th>
                    </thead>
                    <tbody>
