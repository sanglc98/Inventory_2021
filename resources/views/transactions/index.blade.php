            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('transactions.create', ['type' => 'payment']) }}" class="btn btn-sm btn-primary">Thanh toán</a>
                        <a href="{{ route('transactions.create', ['type' => 'income']) }}" class="btn btn-sm btn-primary">Thu nhập</a>
                        <a href="{{ route('transactions.create', ['type' => 'expense']) }}" class="btn btn-sm btn-primary">Chi phí</a>
                        <a href="{{ route('sales.create') }}" class="btn btn-sm btn-primary">Bán</a>
                        <a href="{{ route('transfer.create') }}" class="btn btn-sm btn-primary">Chuyển khoản</a>
                    </div>
                </div>
            </div>
        </div>
