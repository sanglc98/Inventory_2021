...
@section('content')
                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h5 class="card-category">Tổng doanh số</h5>
                            <h2 class="card-title">Hàng năm</h2>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                            <label class="btn btn-sm btn-primary btn-simple active" id="0">
                                <input type="radio" name="options" checked>
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Sản phẩm</span>
                            ...
                            <label class="btn btn-sm btn-primary btn-simple" id="1">
                                ...
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Mua</span>
                                <span class="d-block d-sm-none">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Số dư tháng</h5>
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Chi tiêu tháng trước</h5>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card card-tasks">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Đơn hàng xử lý</h4>
                        </div>
                        <div class="col-4 text-right">
                            <a href="{{ route('sales.create') }}" class="btn btn-sm btn-primary">Tạo đơn mới</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
